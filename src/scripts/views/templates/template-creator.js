...
const createRestaurantItemTemplate = (restaurant) => /*html*/ `
  <section class="card d-flex mb-3 bg-white text-black">
    <div class="card-head position-relative">
      <picture>
        <source media="(max-width: 767px)" srcset="${CONFIG.BASE_IMAGE_URL_SMALL + restaurant.pictureId}">
        <img class="lazyload" src="${CONFIG.BASE_IMAGE_URL_MEDIUM + restaurant.pictureId}" alt="Gambar ${restaurant.name}" crossorigin="anonymous">
      </picture>
...
const createRestaurantDetailTemplate = (restaurant) => /*html*/ `
  <section class="card d-flex flex-column mb-3 bg-white text-black">
    <div class="d-flex w-100">
      <picture>
        <source media="(max-width: 767x)" srcset="${CONFIG.BASE_IMAGE_URL_SMALL + restaurant.pictureId}">
        <img class="lazyload" src="${CONFIG.BASE_IMAGE_URL_MEDIUM + restaurant.pictureId}" alt="Gambar ${restaurant.name}" crossorigin="anonymous">
      </picture>
